...
> [!important] 
> The notebook for storing every process of this project can be seen in folder [notebook](https://github.com/LingAdeu/customer-churn-prediction/blob/main/notebook/notebook.ipynb). Alternatively, kindly see [NBViewer version](https://nbviewer.org/github/LingAdeu/customer-churn-prediction/blob/main/notebook/notebook.ipynb) for a better display. Additionally, to view our Tableau dashboard, use this [URL](https://public.tableau.com/app/profile/adelia.januarto/viz/Customer-Churn-DA/Dashboard-01).
